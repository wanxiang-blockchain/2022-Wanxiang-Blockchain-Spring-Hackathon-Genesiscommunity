    ...
    return fileList.map((res, index) => {
      return (
        <div key={index} className={styles.progressListBox}>
          ...
          <Progress
            strokeColor={{
              from: 'rgba(63, 249, 220, 0.5)',
              to: 'rgba(63, 249, 220, .7)',
            }}
            trailColor="rgba(63, 249, 220, 0.1)"
            strokeWidth={2}
    ...
    <div>
      ...
      >
        <div className={styles.modelTitleBox}>
          <div className={styles.titleText}>文件传输列表</div>
      ...
      >
        <SwapOutlined rotate={90} style={{ color: 'white  ', fontSize: '24px' }} />
      </div>
    </div>
  );
};
